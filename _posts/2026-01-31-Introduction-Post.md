...
This stepping-stone of a project was a nice practice run for the GitHub pages setup, as well as how to host a webpage on a local device. I also hope that this blogging system helps to keep me in check and will provide a visual representation of my growth throughout this class.


Seeing as this is only an introduction post, I think it should be the best of my posts, as there is really nothing else to comment on at this time. So I bid you a good evening, or afternoon, or, if you are for somereason reading this at an unreasonable hour, good morning.
